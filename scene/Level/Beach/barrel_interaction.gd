...
func mulai_dialog():
	...
	Dialogic.start("res://dialogic_component/timelines/go_to_village_dialogue.dtl")
	
	await Dialogic.timeline_ended
	
	
	var keputusan_player = Dialogic.VAR.get_variable("go_to_village_dialogue.go_to_village")
